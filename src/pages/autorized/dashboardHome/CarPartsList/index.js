              ...
              <div key={index} className='car-parts-list-container'>
                ...
                <div className='car-parts-list-grid'>
                    ...
                    <div className='col-3 car-parts-info'>
                      <p>Automobilis : {part.carBrand} {part.carModel}</p>
                      <p>Metai : {part.carYear}</p>
                      <p>Kodas: {part.partCode}.</p>
                    </div>
                    <div className='col-4 car-parts-info'>
                      <p>Statusas : {part.selectedStatus}</p>
                      <p>Data: {part.displayTodaysDate}</p>
                      <h5>CarID: {part.carId} / CarPartID: {part.carPartId} / Part_id: {part.part_id} / Lentyna: {part.placeInWarehouse}</h5>
                    </div>
                </div>
